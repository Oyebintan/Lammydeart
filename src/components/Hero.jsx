  ...
  return (
    <section className="relative overflow-hidden bg-[#03050a] pt-24 pb-8 px-6 lg:px-14">
      ...
      >
        ...
        {/* Visual */}
        <motion.div variants={item} className="relative flex flex-col gap-4">
          <motion.div
            animate={{ opacity: [0.5, 0.85, 0.5] }}
            transition={{ duration: 4.5, repeat: Infinity, ease: "easeInOut" }}
            className="absolute -top-4 right-0 w-44 h-44 rounded-full bg-[radial-gradient(circle,rgba(96,165,250,0.28),rgba(29,78,216,0.1)_60%,transparent_75%)] blur-sm pointer-events-none"
          />
          ...
          >
            ...
            <motion.div
              ...
              className="absolute top-3 -right-3.5 flex items-center gap-2 py-2 px-3 rounded-2xl bg-[rgba(11,21,38,0.85)] backdrop-blur-md border border-[rgba(147,197,253,0.2)] shadow-[0_10px_24px_-10px_rgba(0,0,20,0.6)]"
            >
          ...
          <motion.div
            ...
            initial="hidden"
            animate="show"
            className="grid grid-cols-3 gap-3 max-w-md mx-auto lg:mx-0 w-full"
          >
            <motion.div
              variants={item}
              whileHover={{ y: -3 }}
              className="rounded-[18px] bg-[rgba(147,197,253,0.04)] border border-[rgba(147,197,253,0.14)] p-3.5 flex flex-col justify-between gap-2"
            >
            ...
            <motion.div
              variants={item}
              whileHover={{ y: -3 }}
              className="rounded-[18px] bg-gradient-to-br from-[rgba(29,78,216,0.14)] to-[rgba(96,165,250,0.05)] border border-[rgba(147,197,253,0.14)] p-3.5 flex flex-col justify-between items-start gap-2"
            >
              <div className="text-[10.5px] font-bold tracking-[0.08em] uppercase text-[rgba(219,234,254,0.5)]">
                Mark
              </div>
            ...
            <motion.div
              variants={item}
              whileHover={{ y: -3 }}
              className="relative rounded-[18px] bg-[rgba(147,197,253,0.04)] border border-[rgba(147,197,253,0.14)] p-3.5 flex flex-col justify-between gap-2 overflow-hidden"
            >
